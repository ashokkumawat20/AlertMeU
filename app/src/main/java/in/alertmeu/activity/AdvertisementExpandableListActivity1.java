...
public class AdvertisementExpandableListActivity1 extends AppCompatActivity {
    ...
    private ImageView settings, maps;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                    Intent intent = new Intent(AdvertisementExpandableListActivity1.this, SettingsActivity.class);
        ...
        maps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                    Intent intent = new Intent(AdvertisementExpandableListActivity1.this, HomePageActivity.class);
                    startActivity(intent);
                    finish();
        ...
        naviBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                    Intent intent = new Intent(AdvertisementExpandableListActivity1.this, UserProfileSettingActivity.class);
                    startActivity(intent);
                    finish();
        ...
        btnshopPrec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (AppStatus.getInstance(AdvertisementExpandableListActivity1.this).isOnline()) {
                    Intent intent = new Intent(AdvertisementExpandableListActivity1.this, BusinessExpandableListViewActivity.class);
                    startActivity(intent);
                } else {

                    Toast.makeText(AdvertisementExpandableListActivity1.this, res.getString(R.string.jpcnc), Toast.LENGTH_SHORT).show();
                }
            }
        });
        if (AppStatus.getInstance(AdvertisementExpandableListActivity1.this).isOnline()) {
    ...
    private class getMainCategoryList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(AdvertisementExpandableListActivity1.this);
        ...
        protected void onPostExecute(Void args) {
            ...
            for (int i = 0; i < advertisementDAOList.size(); i++) {
                list1.add(advertisementDAOList.get(i).getMain_cat_name());
            }
            for (MainCatModeDAO temp : data) {

                // Check if theis element is
                // present in list2 or not
                if (list1.contains(temp.getCategory_name())) {
...
*/
                ...
                for (int i = 0; i < data1.size(); i++) {
                    ...
                    for (int j = 0; j < advertisementDAOList.size(); j++) {
                        if (data1.get(i).getCategory_name().equals(advertisementDAOList.get(j).getMain_cat_name())) {
                ...
                mCatMianSubAdapter = new CatMianSubAdapter(AdvertisementExpandableListActivity1.this, mainSubCatDAOArrayList);
    ...
    public void onBackPressed() {
        // TODO Auto-generated method stub
        super.onBackPressed();
        Intent setIntent = new Intent(AdvertisementExpandableListActivity1.this, HomePageActivity.class);
